    ...
    def __init__(
        ...
        *,
        ...
        if not all(isinstance(c, Component) for c in self._components):
            raise TypeError(
                "All components in a `dataset_component` must be subclasses of `Component`"
            )
